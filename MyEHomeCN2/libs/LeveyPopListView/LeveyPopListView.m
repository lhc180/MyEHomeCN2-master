...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    id object = _options[indexPath.row];
    if ([object isKindOfClass:[MyERoom class]]) {
        MyERoom *r = (MyERoom *)object;
        cell.textLabel.text = r.name;
    }else if ([object isKindOfClass:[MyEDeviceType class]]){
        MyEDeviceType *dt = (MyEDeviceType *)object;
