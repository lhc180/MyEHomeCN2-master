...
- (void)initSortedSegmentsArray
{
    ...
    self.sortedSegments =[[NSMutableArray alloc]initWithArray: [enumerator allObjects]];
//    if ([self.subviews count]) {
//        NSSortDescriptor *sort = [NSSortDescriptor sortDescriptorWithKey:@"self" ascending:YES];
//        NSArray *newArray = [self.subviews sortedArrayUsingDescriptors:@[sort]];
//        self.sortedSegments = [newArray mutableCopy];
//    }
...
//    {
//        [array addObject:[NSNumber numberWithInteger:idx + 1]];
//        idx=[self.selectedIndexes indexGreaterThanIndex: idx];
//    }
//
//    NSLog(@"tap index is %i",tappedSegementIndex);
//    NSLog(@"selectedIndexed is %@",[array componentsJoinedByString:@","]);
    [self selectSegmentsOfSelectedIndexes];
}
