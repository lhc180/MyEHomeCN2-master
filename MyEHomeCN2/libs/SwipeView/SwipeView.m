...
- (BOOL)viewOrSuperview:(UIView *)view isKindOfClass:(Class)myclass
{
    if (view == nil || view == _scrollView)
    {
        return NO;
    }
    else if ([view isKindOfClass:myclass])
    {
        return YES;
    }
    return [self viewOrSuperview:view.superview isKindOfClass:myclass];
}
