...
//MARK:            NSInteger totalColumns = [_dataSource numberOfColumnsInEColumnChart:self];
...
//MARK: 修改的地方
                ...
                }else if (valueGap < 0.0009) {
                    eColumnChartLabel.text = [[NSString stringWithFormat:@"%.4f", valueGap * (10 - i)] stringByAppendingString:[_dataSource highestValueEColumnChart:self].unit];
                }else if (valueGap < 0.009) {
                    eColumnChartLabel.text = [[NSString stringWithFormat:@"%.3f", valueGap * (10 - i)] stringByAppendingString:[_dataSource highestValueEColumnChart:self].unit];
                }else if (valueGap < 0.09){
                    eColumnChartLabel.text = [[NSString stringWithFormat:@"%.2f", valueGap * (10 - i)] stringByAppendingString:[_dataSource highestValueEColumnChart:self].unit];
                }else if (valueGap < 1){
                    eColumnChartLabel.text = [[NSString stringWithFormat:@"%.1f", valueGap * (10 - i)] stringByAppendingString:[_dataSource highestValueEColumnChart:self].unit];
                }else
