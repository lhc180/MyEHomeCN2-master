...
-(void)downloadElecInfoFromServer{
    ...
    [HUD show:YES];
    NSString *str = [NSString stringWithFormat:@"%@?deviceId=%li&action=%i",URL_FOR_SWITCH_ELECT_STATUS,(long)self.device.deviceId,self.dateSegment.selectedSegmentIndex+1];
